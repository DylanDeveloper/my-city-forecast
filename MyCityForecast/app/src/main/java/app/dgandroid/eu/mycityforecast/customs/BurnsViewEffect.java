...
public class BurnsViewEffect extends FrameLayout {
    ...
    public BurnsViewEffect(Context context) {
        this(context, null);
    }

    public BurnsViewEffect(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BurnsViewEffect(Context context, AttributeSet attrs, int defStyle) {
